    ...
    def load_keywords(self):
        ...
        return {
            ...
            "crypto_scam": [
                ...
                "空投", "白 沙", "一级市场", "私募",
                "搬砖", "套利", "高息", "开盒", "矿机",
                "交易所", "U商", "收U", "出U","看盘","日结","666","看盘","連勝","重大勁爆","勁爆","喷水","头像","户籍","288","588","免费","查档","开户","發大財","签到","xi 米","xi米","见收益","17W","强奸","视频验证","百家乐","做的来","电子烟","洗迷来","洗钱","能赚","赞赞赞","多赚","伙食费","远程控制","查询","好顶","大家好"
            ],
            "adult": [
                "约炮", "援交", "包养", "小姐", "嫖娼",
                "黄色", "成人", "情色", "三级", "av",
                "性服务", "上门服务", "特殊服务",
                "一夜情", "找乐子", "寂寞","私密","哟","you","转移","色情","偷拍","劲爆","🔞","社工库","炸裂","简介","http://t.","乱伦","少妇","少女","幼女","上门"
            ],
            "custom": []
        }
